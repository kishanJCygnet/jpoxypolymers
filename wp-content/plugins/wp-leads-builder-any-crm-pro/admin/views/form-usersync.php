...
<div class='leads-builder-heading col-md-12 mt10'><?php echo esc_html__("Capture WordPress users" , "wp-leads-builder-any-crm-pro" ); ?> </div>
<div class='clearfix'></div>
<div class='mt20'>
<div class="form-group col-md-12">
       <div class="col-md-3">
            <label id="innertext"  class='leads-builder-label'><?php echo esc_html__( 'Select Plugin-Custom Fields ' , 'wp-leads-builder-any-crm-pro' ); ?></label>
        </div>
        <div class="col-md-2">
...
<div class="form-group col-md-12">
       <div class="col-md-3">
        ...
        <div class="col-md-2">
        <select name="choose_module" id="choose_module" class='form-control' data-live-search='false' onchange="wpSyncSettingsPRO( this )">
				<option value="Leads" 
				<?php
	...
	<div class="col-md-1">
        <?php
                        ...
                        <input type="button" value="<?php echo esc_attr__('Configure Mapping' , 'wp-leads-builder-any-crm-pro' );?>" class="smack-btn smack-btn-primary btn-radius" onClick="window.location.href='<?php echo site_url()."/wp-admin/admin.php?page=lb-usermodulemapping"; ?>'" />
        </div>
</div>
...
<div class="form-group col-md-12">
       <div class="col-md-3">
            <label id="innertext" class='leads-builder-label'><?php echo esc_html__("On Duplicate Data" , "wp-leads-builder-any-crm-pro" ); ?></label>
        </div>
        <div class="col-md-2">
        <select name="duplicate_handling" id="duplicate_handling" class='form-control col-md-2' onchange="wpSyncDuplicateSettingsPRO( this )">
                                <option value="skip"
				<?php
...
<div class="form-group col-md-12">
       <div class="col-md-3">
            <label  id="innertext" class='leads-builder-label'><?php echo esc_html__("WP User Auto Sync" , "wp-leads-builder-any-crm-pro" ); ?> <?php echo str_repeat( '&nbsp' , 13 );  ?></label>
        </div>
        <div class="col-md-2">
            <?php
	...
	<input type="hidden" id="site_url" value="<?php echo site_url(); ;?>">
        ...
        <div class='col-md-1'>
             <input type="button"  id="OneTimeSync" class="OTMS smack-btn smack-btn-primary btn-radius" <?php if( $switch_sync_button == "On" ) { echo "disabled"; } ?> value="<?php echo esc_attr__('One Time Manual Sync ', 'wp-leads-builder-any-crm-pro' );?>" class="button-secondary submit-add-to-menu innersave" onclick="captureAlreadyRegisteredUsersPRO('<?php echo site_url(); ?>');"/>
               </td>
        </div>
</div>
...
<div class="form-group col-md-12">
       <div class="col-md-3">
            <div id='Lead_owner' style="width:250px;">
                 <label id="innertext" class='leads-builder-label'><?php echo esc_html__("Lead Owner" , "wp-leads-builder-any-crm-pro" ); ?> <?php echo str_repeat( '&nbsp' , 26);  ?></label>
             </div>
             <div id='Contact_owner' style="width:250px;">    
                 <label id="innertext" class='leads-builder-label' ><?php echo esc_html__("Contact Owner" , "wp-leads-builder-any-crm-pro" ); ?> <?php echo str_repeat( '&nbsp' , 20 );  ?></label>
             </div>    
        </div>
        <div class="col-md-2">
            <?php echo $html_leads; ?> 
...
<div class='col-md-3'><label  id="inneroptions" class='leads-builder-heading'><?php echo esc_html__("NOTE" , "wp-leads-builder-any-crm-pro" ); ?> </label></div></div>

<div class="form-group col-md-12 notes">
       <div class="col-md-3">
            <label id="innertext" class='leads-builder-label'><?php echo esc_html__("WP User Auto Sync" , "wp-leads-builder-any-crm-pro" ); ?></label>
...
<div class="form-group col-md-12 notes">
       <div class="col-md-3">
             <label  id="innertext" class='leads-builder-label'><?php echo esc_html__("One Time Manual Sync " , "wp-leads-builder-any-crm-pro" ); ?> <span style="padding-left:9px;">: </span> </label>
        </div>
        <div class="col-md-8">
...
<div id="loading-image" style="display: none; background:url(<?php echo WP_PLUGIN_URL;?>/wp-leads-builder-any-crm-pro/assets/images/ajax-loaders.gif) no-repeat center"><?php echo esc_html__('' , 'wp-leads-builder-any-crm-pro' ); ?></div>
</div>
</div>
</div>
<?php
