		...
		foreach( $get_shortcodes as $key => $shortcodedata )
		{
			...
			if( $crm_type == $shortcodedata->crm_type && $module_type == $module )
			{
				...
				else 
				{
					...
					//$wpdb->get_results("update wp_smackleadbulider_form_field_manager set wp_field_mandatory = '$field_mandatory' {$state} , custom_field_values = '$field_values' where rel_id = '{$rel_id}'");
