				...
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
					<div class="list-group">
						<a href="#" class="list-group-item active text-center">
							<span class="dashicons dashicons-format-image"></span><br/><?php esc_html_e( 'Add Images', 'new-album-gallery' ); ?>
						</a>
						<a href="#" class="list-group-item text-center">
							<span class="dashicons dashicons-admin-generic"></span><br/><?php esc_html_e( 'Config', 'new-album-gallery' ); ?>
						</a>
						<a href="#" class="list-group-item text-center">
							<span class="dashicons dashicons-admin-appearance"></span><br/><?php esc_html_e( 'Animation & Hover Effect', 'new-album-gallery' ); ?>
						</a>
						<a href="#" class="list-group-item text-center">
							<span class="dashicons dashicons-cart"></span><br/><?php esc_html_e( 'Upgrade To Pro', 'new-album-gallery' ); ?>
						</a>
					</div>
				</div>
				<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab">
					<div class="bhoechie-tab-content active">
						<h1><?php esc_html_e( 'Add Images', 'new-album-gallery' ); ?></h1>
						<hr>	
						<div id="album-gallery">
							<input type="button" id="remove-all-image-slides" name="remove-all-image-slides" class="button button-large remove-all-image-slides" rel="" value="<?php esc_html_e( 'Delete All Images', 'new-album-gallery' ); ?>">
							...
							if ( isset( $allimagesetting['image-slide-ids'] ) ) {
								...
								<li class="image-slide">
									...
									<select id="image-slide-type[]" name="image-slide-type[]" class="form-control selectbox_position_newslide" value="<?php echo esc_attr( $slide_type ); ?>" >
										<option value="i" 
										<?php
										if ( $slide_type == 'i' ) {
									...
									<!-- Image Title-->
									<input type="text" name="image-slide-title[]" id="image-slide-title[]" class="input_box_newslide" placeholder="Title Here" value="<?php echo esc_html( get_the_title( $id ) ); ?>">
									<input type="text" name="image-slide-link[]" id="image-slide-link[]" class="input_box_newslide" placeholder="Enter URL" value="<?php echo esc_url( $slide_link ); ?>">
					...
					<div class="bhoechie-tab-content">
						<h1><?php esc_html_e( 'Configuration', 'new-album-gallery' ); ?></h1>
						<hr>
						<!--Grid-->
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h5><?php esc_html_e( 'Loop', 'new-album-gallery' ); ?></h5>
								<p><?php esc_html_e( 'Select if the album gallery is loopable', 'new-album-gallery' ); ?></p> 
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field p-4">
								<p class="switch-field em_size_field">
									...
									?>
									<input type="radio" class="form-control" id="loop_lightbox1" name="loop_lightbox" value="true" 
									<?php
									if ( $loop_lightbox == 'true' ) {
										echo 'checked';}
									?>
									>
										<label for="loop_lightbox1"><?php esc_html_e( 'Yes', 'new-album-gallery' ); ?></label>
									<input type="radio" class="form-control" id="loop_lightbox2" name="loop_lightbox" value="false" 
									<?php
									if ( $loop_lightbox == 'false' ) {
										echo 'checked';}
									?>
									> 
										<label for="loop_lightbox2"><?php esc_html_e( 'No', 'new-album-gallery' ); ?></label>				
								</p>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h5><?php esc_html_e( 'Hide Close Button On Mobile', 'new-album-gallery' ); ?></h5>
								<p><?php esc_html_e( 'Select if the Close Button is displayed on mobile', 'new-album-gallery' ); ?></p> 
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field p-4">
								<p class="switch-field em_size_field">
									...
									?>
									<input type="radio" class="form-control" id="hide_close_btn_mobile1" name="hide_close_btn_mobile" value="true" 
									<?php
									if ( $hide_close_btn_mobile == 'true' ) {
										echo 'checked';}
									?>
									>
										<label for="hide_close_btn_mobile1"><?php esc_html_e( 'Hide', 'new-album-gallery' ); ?></label>
									<input type="radio" class="form-control" id="hide_close_btn_mobile2" name="hide_close_btn_mobile" value="false" 
									<?php
									if ( $hide_close_btn_mobile == 'false' ) {
										echo 'checked';}
									?>
									> 
										<label for="hide_close_btn_mobile2"><?php esc_html_e( 'Show', 'new-album-gallery' ); ?></label>			
								</p>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h5><?php esc_html_e( 'Remove Bars On Mobile', 'new-album-gallery' ); ?></h5>
								<p><?php esc_html_e( 'Select if the gallery bars are displayed on mobile', 'new-album-gallery' ); ?></p> 
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field p-4">
								<p class="switch-field em_size_field">
									...
									?>
									<input type="radio" class="form-control" id="remove_bars_mobile1" name="remove_bars_mobile" value="true" 
									<?php
									if ( $remove_bars_mobile == 'true' ) {
										echo 'checked';}
									?>
									>
										<label for="remove_bars_mobile1"><?php esc_html_e( 'Yes', 'new-album-gallery' ); ?></label>
									<input type="radio" class="form-control" id="remove_bars_mobile2" name="remove_bars_mobile" value="false" 
									<?php
									if ( $remove_bars_mobile == 'false' ) {
										echo 'checked';}
									?>
									> 
										<label for="remove_bars_mobile2"><?php esc_html_e( 'No', 'new-album-gallery' ); ?></label>					
								</p>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h5><?php esc_html_e( 'Hide Bars Delay', 'new-album-gallery' ); ?></h5>
								<p><?php esc_html_e( 'Sets the hide bars Delay time in seconds', 'new-album-gallery' ); ?></p> 
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field p-4 range-slider">
								...
								<input type="range" class="range-slider__range" id="hide_bars_delay" name="hide_bars_delay" value="<?php echo esc_attr( $hide_bars_delay ); ?>" min="500" max="10000" step="100">
					...
					<div class="bhoechie-tab-content">
						<h1><?php esc_html_e( 'Animation & Hover Effect', 'new-album-gallery' ); ?></h1>
						<hr>
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h5><?php esc_html_e( 'Hover Effects', 'new-album-gallery' ); ?></h5>
								<p><?php esc_html_e( 'Select the hover effect to apply', 'new-album-gallery' ); ?></p> 
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field p-4">
								<p class="switch-field em_size_field">
									...
									?>
									<input type="radio" class="form-control" id="hover_effects1" name="hover_effects" value="stacks" 
									<?php
									...
									<input type="radio" class="form-control" id="hover_effects2" name="hover_effects" value="none" 
									<?php
									...
									<input type="radio" class="form-control" id="hover_effects3" name="hover_effects" value="overlay" 
									<?php
						...
						<div class="col-md-4">
							<div class="ma_field_discription">
								<h5><?php esc_html_e( 'Animation', 'new-album-gallery' ); ?></h5>
								<p><?php esc_html_e( 'Select to apply animation on gallery', 'new-album-gallery' ); ?></p> 
							</div>
						</div>
						<div class="col-md-8">
							<div class="ma_field p-4">
								...
								<select id="animations" name="animations" class="selectbox_position">
									...
									if ( $animations == 'none' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'None', 'new-album-gallery' ); ?></option>
									<option value="wobble" 
									<?php
									if ( $animations == 'wobble' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Wobble', 'new-album-gallery' ); ?></option>
									<option value="bounce" 
									<?php
									if ( $animations == 'bounce' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Bounce', 'new-album-gallery' ); ?></option>
									<option value="flash" 
									<?php
									if ( $animations == 'flash' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Flash', 'new-album-gallery' ); ?></option>
									<option value="jello" 
									<?php
									if ( $animations == 'jello' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Jello', 'new-album-gallery' ); ?></option>
									<option value="pulse" 
									<?php
									if ( $animations == 'pulse' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Pulse', 'new-album-gallery' ); ?></option>
									<option value="rubberBand" 
									<?php
									if ( $animations == 'rubberBand' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Rubber Band', 'new-album-gallery' ); ?></option>
									<option value="shake" 
									<?php
									if ( $animations == 'shake' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Shake', 'new-album-gallery' ); ?></option>
									<option value="tada" 
									<?php
									if ( $animations == 'tada' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Tada', 'new-album-gallery' ); ?></option>
									<option value="swing" 
									<?php
									if ( $animations == 'swing' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Swing', 'new-album-gallery' ); ?></option>
									<option value="rollIn" 
									<?php
									if ( $animations == 'rollIn' ) {
										echo 'selected=selected';}
									?>
									><?php esc_html_e( 'Roll In', 'new-album-gallery' ); ?></option>
								</select>
							</div>
						</div>
					...
					<div class="bhoechie-tab-content">
						<h1><?php esc_html_e( 'Upgrade To Pro', 'new-album-gallery' ); ?></h1>
						<hr>
						<!--Grid-->
